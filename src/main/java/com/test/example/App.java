...
public class App 
{
	public static void main(String args[]) {
		...
		if (port == null || port.equals("")) {
			...
			System.out.println("To connect to api.korbit.co.kr:8080 (korbitdevday.co.kr), set KORBIT_API_PORT to 8080.");
			System.out.println("To connect to api.korbit.co.kr (korbit.co.kr), set KORBIT_API_PORT to 443.");
		}
		...
		if (username == null || username.equals("") || password == null || password.equals("")) {
			...
			System.out.println("To connect to api.korbit.co.kr:8080, use your username and password on korbitdevday.co.kr.");
