...
then
	...
	echo "To connect to api.korbit.co.kr:8080 (korbitdevday.herokuapp.com), set KORBIT_API_PORT to 8080."
...
then
	...
	echo "To connect to api.korbit.co.kr:8080, use your username and password on korbitdevday.herokuapp.com."
